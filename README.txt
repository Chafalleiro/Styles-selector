...
1. Upload `styleselector` directory to the `/wp-content/plugins/` directory
...
1. /assets/screenshot_1.jpg Shows the options panel. Here you configure the plugin
2. /assets/screenshot_2.jpg Shows the inspector developer tool of a browser. You can use it to explore the elements of a page.
3. /assets/dark.jpg Shows a page dark themed by the plugin.
2. /assets/restored.jpg Shows a page restored by the plugin.
